...
navToggleButton.element.addEventListener("click", () => {
    ...
    if (navToggleButton.collapsed === true) {
      navToggleButton.element.innerHTML = `<img src="${navToggleButton.closeImage}" alt="close button">`;
      navToggleButton.collapsed = false;
    } else {
      navToggleButton.element.innerHTML = `<img src="${navToggleButton.openImage}" alt="close button">`;
