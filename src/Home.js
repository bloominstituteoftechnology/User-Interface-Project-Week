      ...
      <div className="container home-page">
        ...
        <section className="bottom-content">
          ...
          <div className="bottom-items">
            ...
            <img src={villaMobile} alt="" className="img--mobile" />
          ...
          <div className="bottom-items">
            <img src={outskirtsDesktop} alt="" className="img--desktop" />
            <img src={outskirtsMobile} alt="" className="img--mobile" />
          ...
          <div className="bottom-items">
            <img src={blockDesktop} alt="" className="img--desktop" />
            <img src={blockMobile} alt="" className="img--mobile" />
