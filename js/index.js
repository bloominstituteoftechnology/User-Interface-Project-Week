/*class Dropdown {
  ...
  let dropdowns = document.querySelectorAll('.nav');
  dropdowns = Array.from(dropdowns).map( dropdown => new Dropdown(dropdown));class Dropdown {
    constructor(element) {
      // assign this.element to the dropdown element
      this.element = element;
      // assign the ".dropdown-button" class found in the dropdown element (look at the HTML for context)
  ...
  hamburger.addEventListener('click', () => console.log(menu.html));*/
