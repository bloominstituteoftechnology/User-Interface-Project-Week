class Carousel {
  ...
  prev() {
    ...
    let text = document.querySelectorAll('.subtext');
    text.forEach( txt => txt.classList.add('hide'));
    document.querySelector(`.subtext[data-pict='${this.image.dataset.pict}']`).classList.remove('hide');
  }
  next() {
