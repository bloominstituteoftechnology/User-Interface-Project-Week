...
// class TabNav {
//     constructor(tabs) {
//         this.tabs = tabs.map((eachTab) => {
//             eachTab.addEventListener('click', (e) => {
//                 this.updateActive(e.target);
//             }); 
//             return eachTab;
//         });
...
//         selected.classList.add("tab_selected");   

//         let tabNumber = this.activeTab.dataset.tab;
//     //    let activeContent = this.tabContent.querySelector(`[data-content='${tabNumber}']'`);
//     //    console.log(activeContent);
//     }
// }

// const tabLinks = document.querySelectorAll('.each-tab');
// let tabContent = document.querySelector(".all-tab-content");
// let tabNav = new TabNav(Array.from(document.querySelectorAll(".each-tab")));
