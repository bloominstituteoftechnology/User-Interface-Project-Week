class TabLink {
    constructor(tab){
        ...
        this.contentItem = document.querySelector(`.content[data-tab='${this.data}']`);
    ...
    select() {
        ...
        Array.from(tabLinks).forEach(link => link.classList.remove('services-tab-selected'));
...
class TabContent {
    ...
    select() {
        ...
        Array.from(tabContent).forEach(content => content.classList.remove('content-selected'));
